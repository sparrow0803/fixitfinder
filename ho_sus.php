...
<head>
    ...
    <title>Suspended Homeowners</title>
...
<p class="fs-2 text-center">SUSPENDED HOMEOWNERS</p>
<hr>
    ...
    <tbody>
        ...
        ?>
               <tr>
                    ...
                    <td scope="col" class="text-center"><?= $row['lift_suspension']; ?></td>
