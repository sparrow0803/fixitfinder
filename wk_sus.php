...
<div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="infomodalLabel">Suspension Record</h1>
...
<p class="fs-2 text-center">SUSPENDED WORKERS</p>
<hr>
...
<table id="myTable" class="table table-responsive table-hover table-bordered" style="border-color:#043047;">
    ...
    <thead>
      <tr>
        ...
        <th scope="col" class="text-center">Reactivation Date</th>
    ...
    <tbody>
        ...
        if(is_array($fetchdata) && is_array($fetchdata2)){
            foreach($fetchdata as $key => $row){
              foreach($fetchdata2 as $key2 => $row2){
                if($row2['worker_verification'] != 'Suspended' || $key2 != $key){
                    continue ;
                }
                else{
                    $count += 1;
        ?>
               <tr>
                    ...
                    <td scope="col" class="text-center"><?= $row2['lift_suspension']; ?></td>
